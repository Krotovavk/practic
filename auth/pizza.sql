...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 28 2020 г., 21:53
...
INSERT INTO `user_acounts` (`user_id`, `name`, `password`, `email`) VALUES
(1, 'admin', 'a0bdac0fdc9076828db507e20d029b86', 'admin@mail.ru');
...
--
ALTER TABLE `user_rights`
  MODIFY `rights_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
